...
A rewrite of the protocol as Markdown can be found [here](data/PROTOCOL.md). Otherwise, the [pdf](The serial communication of the MX1_MXULF_V5_9.pdf) still applies.
